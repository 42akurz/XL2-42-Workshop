...
class TestStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    // Print the CloudFront distribution url to the console (the url where your frontend is served)
    new CfnOutput(this, "YourCfnOuptut", {
      description: "CloudFront: Frontend Endpoint",
